...
const args400 = {emails: "invalid400@gmail.com", passwords: "123", names: "Invalid"}; // Salah nama field
const argsLogin = {email: "user@gmail.com", password: "123"}; // Login
const argsRegister = {email: "user_regis@gmail.com", password: "123", name: "Invalid"}; // Register
...
const user = {idUser: 2, nama: "Invalid", kota: "SYSTEM", alamat: "SYSTEM", noHp: "+628123456789"}; // Data User Update
...
describe("User Controller", () => {
    ...
    it("UPDATE INFO USER - Jika gagal update info user -> response code 500", async () => {
        return await request(app)
            .put("/api/v1/profile")
            .send(user400)
            .then((res) => {
